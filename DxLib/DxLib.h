...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x308c
#define DXLIB_VERSION_STR _T( "3.08c" )
...
extern	int			BltDrawValidGraph( int TargetDrawValidGrHandle, int x1, int y1, int x2, int y2, int DestX, int DestY, int DestGrHandle ) ;	// 描画可能画像から指定領域のグラフィックを取得する
